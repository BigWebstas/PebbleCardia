...
| **Phone** | `src/pkjs/index.js` logs every status heartbeat and episode to the JS console and keeps a rolling 100-episode log in `localStorage`, viewable/exportable from the app config page. |
